...
public class DomainLocation {
    ...
    public static class LocationNode {
        private String fqn; private String name; private String description;
        private String entitySchemaFqn; private int depth;
    ...
    public String getEntityFqn() { return entityFqn; } public void setEntityFqn(String entityFqn) { this.entityFqn = entityFqn; }
    public List<LocationNode> getPath() { return path; } public void setPath(List<LocationNode> path) { this.path = path; }
    public boolean isComplete() { return complete; } public void setComplete(boolean complete) { this.complete = complete; }
