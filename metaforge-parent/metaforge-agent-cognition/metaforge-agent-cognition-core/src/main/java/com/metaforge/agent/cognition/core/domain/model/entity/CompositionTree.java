...
public class CompositionTree {
    private String rootFqn; private String direction; private TreeNode root;
    private boolean truncated; private String truncatedReason;
    public static class TreeNode {
        private String fqn; private String name; private String entitySchemaFqn; private int depth;
        private List<TreeNode> children; private List<TreeNode> parentChain;
        ...
        public List<TreeNode> getParentChain() { return parentChain; } public void setParentChain(List<TreeNode> parentChain) { this.parentChain = parentChain; }
    }
    public String getRootFqn() { return rootFqn; } public void setRootFqn(String rootFqn) { this.rootFqn = rootFqn; }
    public String getDirection() { return direction; } public void setDirection(String direction) { this.direction = direction; }
    public TreeNode getRoot() { return root; } public void setRoot(TreeNode root) { this.root = root; }
    public boolean isTruncated() { return truncated; } public void setTruncated(boolean truncated) { this.truncated = truncated; }
    public String getTruncatedReason() { return truncatedReason; } public void setTruncatedReason(String truncatedReason) { this.truncatedReason = truncatedReason; }
}
