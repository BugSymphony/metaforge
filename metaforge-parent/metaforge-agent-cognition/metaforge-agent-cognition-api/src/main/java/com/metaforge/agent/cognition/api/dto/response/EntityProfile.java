...
public class EntityProfile {
    ...
    public List<NativeAttributeDetail> getSchemaAttributes() { return schemaAttributes; }
    public void setSchemaAttributes(List<NativeAttributeDetail> schemaAttributes) { this.schemaAttributes = schemaAttributes; }
